      ...
      <aside id="sidebar" class="sidebar">
         <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <i class="fa-solid fa-gauge"></i>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="#"> <i class="fa-solid fa-wallet"></i><span>Transaction</span> </a>
        ...
        <!-- <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="/corporatesyy"> <i class="fa-solid fa-code-compare"></i><span>Corporates</span> </a>
