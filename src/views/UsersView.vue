    ...
    <aside id="sidebar" class="sidebar">
         <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <i class="fa-solid fa-gauge"></i>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="#"> <i class="fa-solid fa-user"></i><span>Users</span> </a>
        ...
        <!-- <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="/corporates"> <i class="fa-solid fa-code-compare"></i><span>Corporates</span> </a>
                        ...
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer" >
                            ...
                            <tbody>
                                ...
                                <tr v-for="user in filteredData ">
                                    ...
                                    <td>{{ user.email }}</td>
                                    <td><span>{{ user.organization ? 'Corporates' : '' }}</span></td>
                                    <td>
                            ...
                            data-bs-target="#updateUserModal"><i class="fa fa-pencil-alt text-success font-weight-600" @click="edit(user)"  ></i></a>
                                        </span>
                                        <span class="actionCust">
                                          
                                            <a href="#" type="button"  @click="toggleUser(user)"><i class="fa fa-toggle-on text-success">{{ user.isDisabled ? '' : '' }}</i></a>
 ...
 // filteredData() {
    ...
    // },
      ...
      totalPages(){
            ...
            return this.users.length && (this.users.length > this.perPage) ? Math.ceil(this.users.length/this.perPage) : 1;
        },
           start(){
          ...
          stop(){
            ...
            if((this.users.length - this.start) >= this.perPage){
